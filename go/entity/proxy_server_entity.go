...
import (
	...
	vs "github.com/voxgig-sdk/belkavpn-sdk/go/utility/struct"
)

type ProxyServerEntity struct {
	name    string
	client  *core.BelkavpnSDK
...
func NewProxyServerEntity(client *core.BelkavpnSDK, entopts map[string]any) *ProxyServerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProxyServerEntity) GetName() string { return e.name }
...
func (e *ProxyServerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProxyServerEntity) Deleted() bool {
	return e.deleted
}


func (e *ProxyServerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProxyServerEntity(e.client, opts)
}

func (e *ProxyServerEntity) Data(args ...any) any {
...
func (e *ProxyServerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProxyServer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProxyServerEntity) DataTyped(data ...ProxyServer) ProxyServer {
	if len(data) > 0 {
		return typedFrom[ProxyServer](e.Data(asMap(data[0])))
	}
	return typedFrom[ProxyServer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProxyServer (all fields
// optional at the wire level).
func (e *ProxyServerEntity) MatchTyped(match ...ProxyServer) ProxyServer {
	if len(match) > 0 {
		return typedFrom[ProxyServer](e.Match(asMap(match[0])))
	}
	return typedFrom[ProxyServer](e.Match())
}
...
func (e *ProxyServerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProxyServerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ProxyServerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProxyServerListMatch and returns []ProxyServer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProxyServerEntity) ListTyped(reqmatch ProxyServerListMatch, ctrl map[string]any) ([]ProxyServer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProxyServer](res), nil
}



func (e *ProxyServerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProxyServerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProxyServerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProxyServerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
