...
module BelkavpnTestRunner
  ...
  def self.env_override(m)
    live = getenv("BELKAVPN_TEST_LIVE")
    override = getenv("BELKAVPN_TEST_OVERRIDE")
    ...
    explain = getenv("BELKAVPN_TEST_EXPLAIN")
    m["BELKAVPN_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BelkavpnTestRunner
Helpers = BelkavpnHelpers
Vs = VoxgigStruct
