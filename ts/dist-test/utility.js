...
function envOverride(m) {
    if ('TRUE' === process.env.BELKAVPN_TEST_LIVE ||
        'TRUE' === process.env.BELKAVPN_TEST_OVERRIDE) {
    ...
    m.BELKAVPN_TEST_EXPLAIN = process.env.BELKAVPN_TEST_EXPLAIN || m.BELKAVPN_TEST_EXPLAIN;
    return m;
}
