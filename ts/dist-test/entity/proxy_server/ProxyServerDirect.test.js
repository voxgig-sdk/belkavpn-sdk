...
(0, node_test_1.describe)('ProxyServerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-proxy_server', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-proxy_server', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BELKAVPN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BelkavpnSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BELKAVPN_TEST_PROXY_SERVER_ENTID'];
    ...
    const client = new __1.BelkavpnSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ProxyServerDirect.test.js.map