...
// Belkavpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BelkavpnTestFeature extends BelkavpnBaseFeature
{
    ...
    public function init(BelkavpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BelkavpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BelkavpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BelkavpnContext $ctx, $op, $args): array
    {
