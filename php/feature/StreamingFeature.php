...
// Belkavpn SDK streaming feature
...
class BelkavpnStreamingFeature extends BelkavpnBaseFeature
{
    ...
    private function _iterate(BelkavpnResult $result): \Generator
    {
    ...
    private function _streamable(BelkavpnContext $ctx): bool
    {
