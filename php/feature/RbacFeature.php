...
class BelkavpnRbacFeature extends BelkavpnBaseFeature
{
    ...
    private function _required(BelkavpnContext $ctx): ?string
    {
    ...
    private function _reject(BelkavpnContext $ctx, string $required): void
    {
    ...
    private function _track(BelkavpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
