...
class BelkavpnTimeoutFeature extends BelkavpnBaseFeature
{
    ...
    private function _with_timeout(BelkavpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BelkavpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
