...
// Belkavpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BelkavpnSDK::test)
...
{
    private const SDK_CLASS = 'BelkavpnSDK';
    ...
    private const SDK_BASE = 'belkavpn_sdk';
