...
class BelkavpnTestRunner
{
    ...
    {
        $live = self::getenv('BELKAVPN_TEST_LIVE');
        $override = self::getenv('BELKAVPN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BELKAVPN_TEST_EXPLAIN');
...
class_alias('BelkavpnTestRunner', 'Runner');
class_alias('BelkavpnHelpers', 'Helpers');
