...
// Belkavpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BelkavpnMakeRequest
{
    public static function call(BelkavpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BelkavpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BelkavpnResponse($fetched);
        } else {
