...
type Args struct {
	Entity string         `json:"entity" jsonschema:"proxy_server"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BelkavpnSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "belkavpn_list",
		Description: "List records from Belkavpn. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "belkavpn_load",
		Description: "Load a single record from Belkavpn. " +
...
func runOp(client *sdk.BelkavpnSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BelkavpnSDK, name string) (sdk.BelkavpnEntity, error) {
	switch strings.ToLower(name) {
	case "proxy_server":
		return client.ProxyServer(nil), nil
