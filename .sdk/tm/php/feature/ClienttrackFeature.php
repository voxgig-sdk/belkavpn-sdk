...
// Belkavpn SDK clienttrack feature
...
class BelkavpnClienttrackFeature extends BelkavpnBaseFeature
{
    ...
    public function PostConstruct(BelkavpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Belkavpn-SDK';
