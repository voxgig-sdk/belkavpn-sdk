...
class BelkavpnNetsimFeature extends BelkavpnBaseFeature
{
    ...
    private function _simulate(BelkavpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BelkavpnContext $ctx, array $applied): void
    {
        $client = $this->client;
