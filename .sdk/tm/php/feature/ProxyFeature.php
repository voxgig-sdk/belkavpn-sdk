...
class BelkavpnProxyFeature extends BelkavpnBaseFeature
{
    ...
    public function init(BelkavpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BelkavpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
