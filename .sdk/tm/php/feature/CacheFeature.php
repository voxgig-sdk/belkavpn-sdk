...
class BelkavpnCacheFeature extends BelkavpnBaseFeature
{
    ...
    private function _through(BelkavpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
