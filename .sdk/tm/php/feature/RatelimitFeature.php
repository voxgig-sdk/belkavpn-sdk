...
// Belkavpn SDK ratelimit feature
...
class BelkavpnRatelimitFeature extends BelkavpnBaseFeature
{
    ...
    private function _acquire(BelkavpnContext $ctx): void
    {
    ...
    private function _track(BelkavpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
