...
// Belkavpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BelkavpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BelkavpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(BelkavpnOmni::structfix($val, Struct::undef()))) {
