...
// Belkavpn SDK utility: fetcher

class BelkavpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BelkavpnSDK/1.0)';
    ...
    public static function call(BelkavpnContext $ctx, string $fullurl, array $fetchdef): array
    {
