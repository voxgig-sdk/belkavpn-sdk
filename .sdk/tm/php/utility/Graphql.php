...
class BelkavpnGraphql
{
    ...
    // equivalent.
    public static function body(BelkavpnContext $ctx): mixed
    {
    ...
    public static function errors(BelkavpnContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
