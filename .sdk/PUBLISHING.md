...
|---|---|---|
| `ts/` | @voxgig-sdk/belkavpn-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/belkavpn-sdk \
      --repository voxgig-sdk/belkavpn-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/belkavpn-sdk` shows it, and
`npm trust revoke @voxgig-sdk/belkavpn-sdk --id=<id>` removes it.
