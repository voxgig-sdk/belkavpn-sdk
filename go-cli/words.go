...
func registerSDKWords(r *eng.Registry, client *sdk.BelkavpnSDK) {
...
func runOp(client *sdk.BelkavpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
