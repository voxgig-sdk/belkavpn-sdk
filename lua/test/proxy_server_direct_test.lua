...
describe("ProxyServerDirect", function()
  it("should direct-list-proxy_server", function()
    local setup = proxy_server_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-proxy_server", setup.live and "live" or "unit")
