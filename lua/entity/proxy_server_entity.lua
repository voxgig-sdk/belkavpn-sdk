...
local ProxyServerEntity = {}
ProxyServerEntity.__index = ProxyServerEntity


function ProxyServerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProxyServerEntity)
  self._name = "proxy_server"
  self._client = client
...
function ProxyServerEntity:get_name()
  return self._name
end


function ProxyServerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProxyServerEntity.new(self._client, opts)
end
...
function ProxyServerEntity:mark_deleted()
  self._deleted = true
end


function ProxyServerEntity:deleted()
  return true == self._deleted
end


function ProxyServerEntity:data_set(args)
  if args ~= nil then
...
function ProxyServerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProxyServerEntity:match_set(args)
  if args ~= nil then
...
function ProxyServerEntity:match_get()
...
function ProxyServerEntity:stream(action, args, callopts)
...
---@param reqmatch ProxyServerListMatch
---@param ctrl? table
---@return ProxyServer[]
---@return string? err
function ProxyServerEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ProxyServerEntity:_run_op(ctx, post_done)
  local utility = self._utility
