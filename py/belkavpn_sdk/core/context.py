...
from belkavpn_sdk.core.control import BelkavpnControl
...
from belkavpn_sdk.core.helpers import get_ctx_prop, to_map
...
class BelkavpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, BelkavpnResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BelkavpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BelkavpnError(code, msg, self)
