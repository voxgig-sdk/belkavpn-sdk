# Belkavpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BelkavpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BelkavpnSDK(...) and BelkavpnSDK.test(...) become
#      BelkavpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "belkavpn_sdk"
_SDK_CLASS = "BelkavpnSDK"
